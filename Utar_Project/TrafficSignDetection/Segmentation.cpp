...
std::map<int, std::string> labelDescriptions = {
    ...
    {38, "Sharp bend"},
    {39, "Danger steep hill ahead warning"},
    {40, "Slowing sign"},
    {41, "T-junction ahead"},
    {42, "Village warning sign"},
    {43, "Snake road"},
    {44, "Railroad level crossing sign"},
    {45, "Under construction"},
    {46, "Accident frequent happened sign"},
    {47, "Stop"},
    {48, "No entry"},
    {49, "No Stopping"},
    {50, "Give way"},
    {51, "Stop for checking purpose"}
};
